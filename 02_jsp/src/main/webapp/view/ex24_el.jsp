...
<%--
 ...
 <h3>su = <%=su %></h3>
 <hr>
 <%--EL에서 변수를 호출할 때는 반드시 pageContext, request, session, application의 속성을
 ...
 <h3>su2 = ${ su2}</h3>
 <hr>
 <%--pageContext, request, session, application의 속성의 이름이 같은 경우 우선순위는
 	pageContext> request> session> application순서대로 이다. --%>
 	...
 	<%--이 때 페이지 이동하자 --%>
 	<%--pageContext와 request는 페이지를 이동하면 초기화됨. --%>
