...
<script type="text/javascript">
	...
	//댓글
	function comm_ins(f) {
		f.action="${pageContext.request.contextPath}/MyController?cmd=comm_ins&cPage=${cPage}";
		f.submit();
	}
	function comm_del(f) {
		f.action="${pageContext.request.contextPath}/MyController?cmd=comm_del&cPage=${cPage}";
		f.submit();
	}
</script>
</head>
